...
map.addControl(ls);
ls.maximizeControl();
map.zoomToExtent(new OpenLayers.Bounds(-39.87,22.74,-38.14,23.68));
}
...
var text = "	<div style='width: 100%;'>\
		...
		<li><a target='blank' href='http://fr.gde-fon.com/download/vieille-carte_Le-Seigneur-des-Anneaux_llaboration/437821/3000x1713' >Provenance du raster : fr.gde-fon.com</a></li>\
		<li><a target='blank' href='http://www.tolkiendil.com/encyclo'>Tolkiendil</a></li>\
		<li><a target='blank' href='http://lotr.wikia.com/wiki/Main_Page'>Wiki LOTR</a></li>\
		</ul></p>\
		...
		<p></p>\
		<p><a target='blank' href='http://esipe.u-pem.fr/'>Ecole Supérieure d'Ingénieurs de l'Université Paris-Est Marne-la-Vallée</a></p>\
		<p><a target='blank' href='http://www.geonef.fr/doc/cours/mapserver-et-wms/projets-esipe-2014/'>Lien vers les autres projets</a></p>\
		<p><a target='blank' href='https://github.com/esipe/seigneur-des-anneaux'>Fork me on Github</a></p>\
		<p><img alt='http://esipe.u-pem.fr/' src='./images/size150px_mini-IG-color.PNG' align='left'/><img alt='http://esipe.u-pem.fr/' src='./images/size150px_Logo-Esipe-mlv.PNG' align='right'/></p>";
...
var text = "	<div style='width: 100%;'>\
		...
		<p>Pour afficher/masquer le panneau que vous consultez actuellement, cliquez sur le bouton situé en bas de l'écran.</p>\
		</p>";
	document.getElementById('information').innerHTML = text;
}
